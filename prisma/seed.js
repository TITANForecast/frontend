...
async function main() {
  ...
  console.log(
    `✓ Created users: ${jayAdmin.name}, ${platformAdmin.name}, ${multiDealerBrandon.name}, ${ryanUser.name}, ${lionelUser.name}`
  );
  ...
  console.log(
    `  - User-Dealer Associations: ${await prisma.userDealer.count()}`
  );
}
