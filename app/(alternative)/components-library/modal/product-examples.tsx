        ...
        <div className="m-1.5">
          ...
          <ModalAction isOpen={integrationModalOpen} setIsOpen={setIntegrationModalOpen}>
            ...
            <div className="mb-5 text-center">
              ...
              <div className="text-lg font-semibold text-gray-800 dark:text-gray-100">Connect TitanForecast with your Cruip account</div>
            </div>
            {/* Modal content */}
            <div className="text-sm mb-5">
              <div className="font-medium text-gray-800 dark:text-gray-100 mb-3">TitanForecast would like to:</div>
              ...
              <div className="text-xs text-gray-500">By clicking on Allow access, you authorize TitanForecast to use your information in accordance with its <a className="text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">Privacy Policy</a>. You can stop it at any time on the integrations page of your TitanForecast account.</div>
            </div>
            {/* Modal footer */}
            <div className="flex flex-wrap justify-end space-x-2">
        ...
        <div className="m-1.5">
          ...
          <ModalBlank isOpen={newsModalOpen} setIsOpen={setNewsModalOpen}>
            <div className="relative">
              <Image className="w-full" src={ModalImage} width={460} height="200" alt="New on TitanForecast" />
              {/* Close button */}
            ...
            <div className="p-5">
              ...
              <div className="mb-2">
                <div className="mb-3">
                  <div className="btn-xs text-xs border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300 px-2.5 py-1 rounded-full shadow-none">New on TitanForecast</div>
                </div>
          ...
          <ModalBasic isOpen={planModalOpen} setIsOpen={setPlanModalOpen} title="Change your Plan">
            ...
            <div className="px-5 pt-4 pb-1">
              <div className="text-sm">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-medium text-gray-800 dark:text-gray-100">TitanForecast Light <span className="text-xs italic text-gray-500 align-top">Current Plan</span></span>
                  ...
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-semibold text-gray-800 dark:text-gray-100">TitanForecast Basic <span className="text-xs italic text-violet-500 align-top">Best Value</span></span>
                  ...
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-semibold text-gray-800 dark:text-gray-100">TitanForecast Plus</span>
                ...
                <div className="text-xs text-gray-500">Your workspace's TitanForecast Light Plan is set to $39 per month and will renew on August 9, 2024.</div>
              </div>
            </div>
            {/* Modal footer */}
            <div className="px-5 py-4">
