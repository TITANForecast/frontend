    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
          Analyze repair orders with flexible grouping by opcode, make, model,
          advisor, and mileage bands
        </p>
      </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
        ...
        <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
          <li>
            • Drag column headers (Opcode, Make, Model, Advisor, Mileage Band)
            to the group area above the grid
          </li>
          <li>
            • Create multi-level grouping by dragging multiple columns (e.g.,
            Advisor → Make → Model)
          </li>
          <li>
