...
import { AuthProvider } from '@/components/auth-provider-multitenancy'
...
export const metadata = {
  title: 'TITAN Forecast Platform',
  description: 'Advanced forecasting and analytics platform for business intelligence',
}
