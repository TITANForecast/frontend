    ...
    <div className="w-full">
      ...
      <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
        ...
        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          <li>
            • <strong>Avatar:</strong> Custom image with fallback and name
            display
          </li>
          <li>
            • <strong>Status:</strong> Colored indicators with status badges
          </li>
          <li>
            • <strong>Score:</strong> Progress bar with color coding
          </li>
          <li>
            • <strong>Progress:</strong> Animated progress bars
          </li>
          <li>
            • <strong>Tags:</strong> Styled tag chips for skills
          </li>
          <li>
            • <strong>Verified:</strong> Icon indicators with text
          </li>
          <li>
            • <strong>Role:</strong> Role badges with emoji icons
          </li>
          <li>
            • <strong>Email:</strong> Clickable mailto links
          </li>
        </ul>
      </div>
    </div>
